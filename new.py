...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def browsefunc():
            ...
            self.filename = filedialog.askopenfilenames(filetypes = (("JPG image", "*.jpg"), ("PNG Image", "*.png")))
            print(self.filename[0])

        def retrieve_input():
            inputValue  = v.get()
              # Path where  we want to save images
            newpath = r'/Users/mukul/Desktop/Opened.ai/images'
            newpath = newpath + '/'
        ...
        videoname = []
        def upload_video():    
            videoname = filedialog.askopenfilenames(filetypes = (("MP4 Video", "*.mp4"), ("AVI Video", "*.avi")))
